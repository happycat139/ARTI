        ...
        <c:forEach var="storybook" items="${storyBooks}">
            <div class="book_info">
                <div class="book_item sample">
                    ...
                    <div class="book_item-coverimg">
                        <c:choose>
                            <c:when test="${not empty storybook.book_thumbnail}">
                                <img src="${storybook.book_thumbnail}" alt="${storybook.book_name}">
                            </c:when>
                            <c:otherwise>
                                <img src="https://storage.googleapis.com/smhrd_arti/images/defaultMypage.png" alt="기본 썸네일">
                            </c:otherwise>
                        </c:choose>
                    </div>
                    <div class="booktitle-top-empty"></div>
                    ...
                    <div class="overlay"></div>
                    <button class="SbmPreview-button" onclick="location.href='/arti/book/storybook?book_idx=${storybook.book_idx}'">미리보기</button>
                </div>
                <div class="book_date"></div>
                <div class="book_info-hover"></div>
            </div>
