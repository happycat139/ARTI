...
public class ChatGPTService {
	...
	public void makeImgPrompt(Long book_idx) {
        ...
        .append("```json\n")
        .append("{\n  \"page\": [페이지 번호],\n  \"description\": \"등장인물: [등장인물 이름과 외형 정보]. 장면: [줄거리를 반영한 장면 설명].\"\n}\n")
        .append("```\n\n")
        .append("### 작성 규칙\n")
        .append("1. 모든 페이지에 등장인물의 외형 정보를 반드시 포함해주세요. 생략하지 마세요.\n")
        .append("   예시: \"난타(작고 날렵한 체구, 짧은 갈색 털, 반짝이는 눈을 가진 다람쥐)\".\n")
        .append("2. 등장인물의 외형 정보는 이름, 얼굴, 키, 옷차림, 머리색 등의 세부 정보를 반드시 포함해야 합니다.\n")
        .append("3. 각 장면은 줄거리를 기반으로 구체적이고 생동감 있게 작성해주세요.\n")
        .append("   예시: \"난타는 부엉이와 함께 숲 속의 작은 공터에서 공연 준비를 위해 토론하고 있었어요. 부엉이는 지혜롭게 조언을 하며 난타를 응원하고 있었어요.\"\n")
        .append("4. 모든 페이지에서 등장인물의 외형 정보가 일관되도록 작성하세요.\n")
        .append("5. 줄거리와 연결된 장면을 구체적으로 설명하고, 단편적이지 않게 작성하세요.\n")
        .append("6. 등장인물이 변경되지 않더라도, 모든 페이지에서 외형 정보를 반복적으로 작성하세요.\n\n")
        .append("### 페이지별 줄거리\n");
